...
const (
	...
	AccessProviderTypeProxmoxBackupServer = AccessProviderType("proxmoxbackupserver")
...
const (
	...
	DeploymentProviderTypeProxmoxBackupServer           = DeploymentProviderType(AccessProviderTypeProxmoxBackupServer)
