...
export interface PurgeProviderPickerProps extends SharedPickerProps<PurgeProvider> {
  showAvailability?: boolean;
}

export interface PurgeProviderPickerInstance {
  inputRef: InputRef | null;
}

const PurgeProviderPicker = forwardRef<PurgeProviderPickerInstance, PurgeProviderPickerProps>(
  ({ className, style, gap = "medium", placeholder, showAvailability = false, showSearch = false, onFilter, onSelect }, ref) => {
    ...
    const renderOption = (provider: PurgeProvider, transparent: boolean = false) => {
      return (
...
export default PurgeProviderPicker;
