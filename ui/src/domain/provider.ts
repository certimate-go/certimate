  ...
  */
  (
    [
      ...
      [ACCESS_PROVIDERS.EMAIL, "provider.email", "/imgs/providers/email.svg", [ACCESS_USAGES.HOSTING, ACCESS_USAGES.NOTIFICATION]],
...
export const deploymentProvidersMap: Map<DeploymentProvider["type"] | string, DeploymentProvider> = new Map(
  ...
  (
    [
      ...
      [DEPLOYMENT_PROVIDERS.EMAIL, "provider.email", DEPLOYMENT_CATEGORIES.OTHER],
