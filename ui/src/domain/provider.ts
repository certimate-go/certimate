  ...
  */
  {
    ...
    VOLCENGINE_CLB_DOMAINEXTENSIONS: `${ACCESS_PROVIDERS.VOLCENGINE}-clb-domainextensions`,
...
export const deploymentProvidersMap: Map<DeploymentProvider["type"] | string, DeploymentProvider> = new Map(
  ...
  (
    [
      ...
      [DEPLOYMENT_PROVIDERS.VOLCENGINE_CLB_DOMAINEXTENSIONS, "provider.volcengine_clb_domainextensions", DEPLOYMENT_CATEGORIES.LOADBALANCE],
