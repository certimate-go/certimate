  ...
  */
  (
    [
      ...
      [ACCESS_PROVIDERS.IBMC, "provider.ibmc", "/imgs/providers/huaweicloud.svg", [ACCESS_USAGES.HOSTING]],
...
export const deploymentProvidersMap: Map<DeploymentProvider["type"] | string, DeploymentProvider> = new Map(
  ...
  (
    [
      ...
      [DEPLOYMENT_PROVIDERS.IBMC, "provider.ibmc", DEPLOYMENT_CATEGORIES.OTHER],
